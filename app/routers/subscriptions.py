...
def subscription_list(request: Request, db: Session = Depends(get_db)):
    # Bolt Optimization: Use eager loading for relationships to avoid N+1 queries
    # and remove redundant full-table dictionary fetches for customers and tariffs.
    stmt = (
    ...
    return render(
        ...
        "subscriptions/list.html",
        {
            ...
            "subscriptions": rows,
            "can_write_crm": True,  # Consistent with other CRM routers
        },
    )
