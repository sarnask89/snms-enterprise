...
import { ADMIN_ONLY_ROLES, createAccessMiddleware, FINANCE_WRITE_ROLES, INTERNAL_READ_ROLES, INTERNAL_WRITE_ROLES, } from './access_control.js';
...
const internalReadOnlyPolicy = {
    readRoles: [...INTERNAL_READ_ROLES],
    writeRoles: [...INTERNAL_READ_ROLES],
};
function mountProtectedRouter(parent, path, policy, child) {
