...
import { mergeDasanDiscoveryRows, parseDasanMacTable, parseDasanOnuInfo, parseDasanOnuStatus, } from "../services/dasan_ssh.js";
...
test("mergeDasanDiscoveryRows combines status/info and preserves mac observations", () => {
    const merged = mergeDasanDiscoveryRows(parseDasanOnuStatus(`
-----------------------------------------------------------------------------
    OLT    | ONU |  ACTIVE  |     Fail Reason      | Profile Name
-----------------------------------------------------------------------------
         1 |   1 |   Active |              Success | H660GM
...
//# sourceMappingURL=network_vendor_parsers.test.js.map