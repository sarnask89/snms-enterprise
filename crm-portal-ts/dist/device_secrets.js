...
export function encryptDeviceSecret(plainText) {
...
export function decryptDeviceSecret(cipherText) {
...
export function hasEncryptedSecret(cipherText) {
    return String(cipherText ?? "").trim().length > 0;
}
//# sourceMappingURL=device_secrets.js.map