...
async function buildCorrespondenceAddress(customer, preResolvedAddress) {
...
async function serializeCustomer(customer, includeDetails = false, preResolvedAddress) {
    ...
    const correspondenceAddress = await buildCorrespondenceAddress(customer, preResolvedAddress);
    return {
        id: customer.id,
