...
const setupLogging = () => {
    ...
    const consoleHandler = new (require('console-handle'))(logFormat); /* Console Handler */
    filehandler = createLogger("info", fs, fileStream);
    return;
};
setupLogging();
export { setup_logging };
//# sourceMappingURL=logger_utils.js.map