...
export async function batchResolveTerytAddresses(inputs) {
    ...
    const streetIds = [...new Set(inputs.map((i) => i.streetId).filter((id) => typeof id === "number" && id > 0))];
    const cityIds = [...new Set(inputs.map((i) => i.cityId).filter((id) => typeof id === "number" && id > 0))];
    const communeIds = [...new Set(inputs.map((i) => i.communeId).filter((id) => typeof id === "number" && id > 0))];
    const districtIds = [...new Set(inputs.map((i) => i.districtId).filter((id) => typeof id === "number" && id > 0))];
    const stateIds = [...new Set(inputs.map((i) => i.stateId).filter((id) => typeof id === "number" && id > 0))];
