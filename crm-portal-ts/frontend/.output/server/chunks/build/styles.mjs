...
const styles = {
  ...
  "layouts/default.vue": () => import('./default-styles.Cz5MGuea.mjs').then(interopDefault),
  ...
  "components/AiAssistant.vue": () => import('./default-styles.Cz5MGuea.mjs').then(interopDefault),
  "components/AiAssistant.vue?vue&type=style&index=0&scoped=7f443aed&lang.css": () => import('./default-styles.Cz5MGuea.mjs').then(interopDefault)
};
