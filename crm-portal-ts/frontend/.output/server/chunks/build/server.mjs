import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { ref, provide, inject, computed, defineComponent, toRefs, getCurrentInstance, h, toValue, useModel, unref, mergeProps, withCtx, renderSlot, createVNode, openBlock, createBlock, createTextVNode, toDisplayString, createCommentVNode, mergeModels, Teleport, toHandlerKey, camelize, toRef, isRef, useSlots, hasInjectionContext, resolveDynamicComponent, Fragment, renderList, shallowRef, cloneVNode, createElementBlock, watch, watchEffect, markRaw, nextTick, Comment, onServerPrefetch, resolveComponent, defineAsyncComponent, useSSRContext, shallowReactive, Suspense, createApp, useId, onErrorCaptured, reactive, effectScope, useTemplateRef, withModifiers, normalizeProps, guardReactiveProps, normalizeStyle, getCurrentScope, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { v as serialize, w as isEqual, x as defu, y as hasProtocol, z as klona, A as isScriptProtocol, q as joinURL, B as parseQuery, C as defuFn, D as withQuery, E as sanitizeStatusCode, F as parseURL, l as encodePath, G as decodePath, H as getContext, I as getRequestHeaders, e as createError$1, J as withTrailingSlash, K as withoutTrailingSlash, $ as $fetch$1, L as baseURL, M as executeAsync } from '../_/nitro.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import colors from 'tailwindcss/colors';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderVNode, ssrRenderStyle, ssrRenderList, ssrRenderSuspense } from 'vue/server-renderer';
import { unrefElement, useDebounceFn, useMounted, reactiveOmit, reactivePick, defaultWindow, useVModel, onKeyStroke, createSharedComposable, useRafFn } from '@vueuse/core';
...
const _routes = [
  {
    ...
    component: () => import('./groups-AJqji6Be.mjs')
  },
  {
    name: "network-devices",
    path: "/network/devices",
    component: () => import('./devices-CAVGfHGk.mjs')
  },
  {
    name: "network-ip-networks",
    path: "/network/ip-networks",
    component: () => import('./ip-networks-R4pysFHY.mjs')
  },
  {
    name: "network-nodes",
    path: "/network/nodes",
    component: () => import('./nodes-Cd9LO4Gj.mjs')
  },
  {
    name: "customers-id",
    path: "/customers/:id()",
  ...
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import('./admin-CfgJBgq9.mjs')
  },
  {
    name: "analytics",
    path: "/analytics",
    component: () => import('./analytics-DmCdNDJP.mjs')
  },
  {
    name: "architect",
    path: "/architect",
  ...
  },
  {
    name: "customers",
    path: "/customers",
    component: () => import('./index-BFQJIvU5.mjs')
  },
  {
    name: "documents",
    path: "/documents",
    component: () => import('./documents-DgWVrue2.mjs')
  },
  {
    name: "finances",
    path: "/finances",
  ...
  },
  {
    name: "helpdesk",
    path: "/helpdesk",
    component: () => import('./helpdesk-DReCdi6H.mjs')
  },
  {
    name: "monitoring",
    path: "/monitoring",
    component: () => import('./monitoring-Wdm0lriC.mjs')
  },
  {
    name: "operations",
    path: "/operations",
  ...
  },
  {
    name: "snms",
    path: "/snms",
    component: () => import('./snms-6_7cD9LX.mjs')
  },
  {
    name: "subscriptions",
    path: "/subscriptions",
    component: () => import('./subscriptions-BUASm9Hf.mjs')
  },
  {
    name: "teryt",
    path: "/teryt",
    component: () => import('./teryt-CKOxrOZK.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-twsfme5q.mjs')
  }
];
...
function filterNavigationLinks(links, role) {
...
const auth_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to) => {
  ...
  [__temp, __restore] = executeAsync(() => loadSession({ silent: true })), await __temp, __restore();
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-_YbzgvVg.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CKLF4M7X.mjs'));
...
export { injectTooltipProviderContext as $, useCollection as A, isNullish as B, Presence_default as C, useFormField as D, usePrimitiveElement as E, usePortal as F, useFieldGroup as G, useComponentIcons as H, isArrayOfArray as I, compare as J, get as K, _sfc_main$c as L, FieldGroupReset as M, looseToNumber as N, getDisplayValue as O, Primitive as P, injectConfigProviderContext as Q, getActiveElement as R, inputIdInjectionKey as S, Teleport_default as T, formFieldInjectionKey as U, VisuallyHidden_default as V, defineKeyedFunctionFactory as W, fetchDefaults as X, useAsyncData as Y, useRequestFetch as Z, _export_sfc as _, __nuxt_component_0$1 as a, useNuxtApp as a0, transformUI as a1, omit as a2, _sfc_main$9 as a3, pickLinkProps as a4, _sfc_main$a as a5, useEmitAsProps as a6, useRequestEvent as a7, useState as a8, AUTOFOCUS_ON_MOUNT as a9, focusFirst as aa, getTabbableCandidates as ab, focus as ac, AUTOFOCUS_ON_UNMOUNT as ad, EVENT_OPTIONS as ae, getTabbableEdges as af, _sfc_main$8 as b, useToast as c, useRoute as d, entry_default as default, _sfc_main$d as e, _sfc_main$7 as f, useRuntimeConfig as g, useAppConfig as h, useComponentUI as i, formBusInjectionKey as j, formStateInjectionKey as k, formErrorsInjectionKey as l, formInputsInjectionKey as m, navigateTo as n, formLoadingInjectionKey as o, formOptionsInjectionKey as p, useForwardExpose as q, createContext as r, useLocale as s, tv as t, useHead as u, useForwardPropsEmits as v, useForwardProps as w, __nuxt_component_0$3 as x, usePortalAuth as y, _sfc_main$b as z };
