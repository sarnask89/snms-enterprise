      ...
      <UCard class="flex flex-col h-[600px]">
        <template #header>
          <div class="flex items-center justify-between">
            ...
            <UButton icon="i-lucide-trash-2" aria-label="Wyczyść historię czatu" color="neutral" variant="ghost" size="xs" @click="clearChat" />
          </div>
        </template>
        ...
        <form @submit.prevent="sendMessage" class="flex gap-2">
          <UInput
            ...
            aria-label="Opisz moduł, który chcesz zbudować"
            class="flex-1"
            :disabled="isLoading"
          />
