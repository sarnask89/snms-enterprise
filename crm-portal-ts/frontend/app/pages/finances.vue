...
const saveInvoice = async () => {
  ...
  try {
    ...
    toast.add({ title: 'Dokument zapisany', color: 'success' })
  } finally {
...
const savePayment = async () => {
  ...
  try {
    ...
    toast.add({ title: 'Płatność dodana', color: 'success' })
  } finally {
...
const saveCashReceipt = async () => {
  ...
  try {
    ...
    toast.add({ title: 'Wpis kasy dodany', color: 'success' })
  } finally {
...
const removeCashReceipt = async (row) => {
  ...
  await refreshCashReceipts()
  toast.add({ title: 'Wpis kasy usunięty', color: 'success' })
}
</script>
