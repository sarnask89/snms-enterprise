...
const saveTariff = async () => {
  ...
  try {
    ...
    toast.add({
      title: 'Zapisano taryfę',
      description: 'Taryfa została zapisana pomyślnie.',
      color: 'success'
    })
  } catch {
    toast.add({
      title: 'Błąd zapisu',
      description: 'Nie udało się zapisać taryfy.',
      color: 'error'
    })
  } finally {
...
const saveInvoice = async () => {
  ...
  try {
    ...
    toast.add({
      title: 'Zapisano dokument',
      description: 'Dokument sprzedaży został zapisany pomyślnie.',
      color: 'success'
    })
  } catch {
    toast.add({
...
const savePayment = async () => {
  ...
  try {
    ...
    toast.add({
      ...
      description: 'Płatność stała została dodana pomyślnie.',
      color: 'success'
    })
  } catch {
    toast.add({
      title: 'Błąd zapisu',
      description: 'Nie udało się dodać płatności stałej.',
      color: 'error'
    })
  } finally {
...
const saveLedgerEntry = async () => {
  ...
  try {
    ...
    toast.add({
      title: 'Błąd zapisu',
      description: 'Nie udało się dodać wpisu do księgi.',
      color: 'error'
    })
  } finally {
...
const saveCashReceipt = async () => {
  ...
  try {
    ...
    toast.add({
      title: 'Błąd zapisu',
      description: 'Nie udało się dodać wpisu kasy.',
      color: 'error'
    })
  } finally {
...
const removeTariff = async (row) => {
  ...
  try {
    ...
    await refreshTariffs()
    toast.add({
      title: 'Usunięto taryfę',
      description: `Taryfa "${row.name}" została pomyślnie usunięta.`,
      color: 'success'
    })
  } catch {
    toast.add({
      title: 'Błąd usuwania',
      description: 'Nie udało się usunąć taryfy.',
      color: 'error'
    })
  }
}
...
const removeInvoice = async (row) => {
  ...
  try {
    ...
    toast.add({
      ...
      description: `Dokument "${row.number}" został pomyślnie usunięty.`,
      color: 'success'
    })
  } catch {
    toast.add({
...
const removePayment = async (row) => {
  ...
  try {
    ...
    await refreshPayments()
    toast.add({
      title: 'Usunięto płatność',
      description: `Płatność stała "${row.name}" została pomyślnie usunięta.`,
      color: 'success'
    })
  } catch {
    toast.add({
      title: 'Błąd usuwania',
      description: 'Nie udało się usunąć płatności stałej.',
      color: 'error'
    })
  }
}
...
const removeLedgerEntry = async (row) => {
  ...
  try {
    ...
    toast.add({
      title: 'Usunięto wpis',
      description: `Wpis "${row.description}" został pomyślnie usunięty z księgi.`,
      color: 'success'
    })
  } catch {
    toast.add({
      title: 'Błąd usuwania',
      description: 'Nie udało się usunąć wpisu z księgi.',
      color: 'error'
    })
  }
}
...
const removeCashReceipt = async (row) => {
  ...
  try {
    ...
    toast.add({
      title: 'Usunięto wpis',
      description: `Wpis kasy "${row.description}" został pomyślnie usunięty.`,
      color: 'success'
    })
  } catch {
    toast.add({
      title: 'Błąd usuwania',
      description: 'Nie udało się usunąć wpisu kasy.',
      color: 'error'
    })
  }
}
