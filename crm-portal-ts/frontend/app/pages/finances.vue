        ...
        <div class="space-y-3">
          ...
          >
            <div class="flex items-start justify-between gap-3">
              ...
              <UButton size="xs" color="error" variant="ghost" icon="i-lucide-trash-2" aria-label="Usuń płatność" @click="removePayment(payment)" />
            </div>
          </div>
        </div>
      </UCard>
        ...
        <div class="space-y-3">
          ...
          >
            <div class="flex items-start justify-between gap-3">
              ...
              <UButton size="xs" color="error" variant="ghost" icon="i-lucide-trash-2" aria-label="Usuń wpis" @click="removeLedgerEntry(entry)" />
            </div>
          </div>
        </div>
      </UCard>
        ...
        <div class="space-y-3">
          ...
          >
            <div class="flex items-start justify-between gap-3">
              ...
              <UButton size="xs" color="error" variant="ghost" icon="i-lucide-trash-2" aria-label="Usuń wpis" @click="removeCashReceipt(receipt)" />
            </div>
          </div>
        </div>
      </UCard>
...
const saveTariff = async () => {
  ...
  try {
    ...
    toast.add({
      ...
      description: 'Zmiany w taryfie zostały pomyślnie zapisane.'
    })
  } finally {
...
const saveInvoice = async () => {
  ...
  try {
    ...
    toast.add({
      ...
      description: 'Dokument finansowy został pomyślnie zapisany.'
    })
  } finally {
...
const savePayment = async () => {
  ...
  try {
    ...
    toast.add({
      ...
      description: 'Nowa płatność stała została zarejestrowana.'
    })
  } finally {
...
const saveLedgerEntry = async () => {
  ...
  try {
    ...
    toast.add({
      title: 'Wpis dodany',
      description: 'Wpis w księdze został pomyślnie dodany.'
    })
  } finally {
...
const saveCashReceipt = async () => {
  ...
  try {
    ...
    toast.add({
      ...
      description: 'Wpis w kasie został pomyślnie dodany.'
    })
  } finally {
...
const removeLedgerEntry = async (row) => {
  ...
  toast.add({
    title: 'Wpis usunięty',
    description: 'Wpis został usunięty z księgi.'
  })
}
...
const removeCashReceipt = async (row) => {
  ...
  toast.add({
    title: 'Wpis usunięty',
    description: 'Wpis został usunięty z kasy.'
  })
}
</script>
