    ...
    <section class="space-y-4">
      <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex flex-wrap items-center gap-2">
          ...
          <UButton icon="i-lucide-arrow-left" color="gray" variant="ghost" to="/customers" label="Wróć do listy" aria-label="Wróć do listy klientów" />
        </div>
      </div>
    ...
    <form v-if="customer" class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_20rem]" @submit.prevent="saveCustomer">
      <section class="space-y-4">
        ...
        <UCard :ui="{ base: 'rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-950', header: { padding: 'px-5 py-4' }, body: { padding: 'px-5 py-5' } }">
          <template #header>
            <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              ...
              <UButton size="sm" color="gray" variant="soft" label="Użyj domyślnego miasta" aria-label="Użyj domyślnego miasta dla adresu korespondencyjnego" @click="applyDefaultAreaToCustomer" />
            </div>
          </template>
        ...
        <UCard :ui="{ base: 'rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-950', header: { padding: 'px-5 py-4' }, body: { padding: 'px-5 py-5' } }">
          <template #header>
            <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              ...
              <UButton v-if="customer.devices?.length" size="xs" color="gray" variant="soft" label="Odśwież klienta" aria-label="Odśwież dane klienta" @click="refresh" />
            </div>
          </template>
            ...
            <div class="space-y-3">
              ...
              >
                <div class="flex items-start justify-between gap-3">
                  ...
                  <UButton size="xs" color="gray" variant="soft" label="Edytuj adres" :aria-label="`Edytuj adres urządzenia ${device.hostname || ''}`.trim()" @click="openDeviceEditor(device)" />
                </div>
              </div>
              </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900/70">
              ...
              <form v-if="isDeviceEditorOpen" class="mt-4 space-y-4" @submit.prevent="saveDeviceAddress">
                ...
                <div class="flex items-center justify-between gap-3">
                  <UButton size="sm" color="gray" variant="soft" label="Użyj domyślnego miasta" aria-label="Użyj domyślnego miasta dla adresu urządzenia" @click="applyDefaultAreaToDevice" />
                  <div class="flex gap-2">
                    <UButton color="gray" variant="ghost" label="Anuluj" aria-label="Anuluj edycję adresu urządzenia" @click="isDeviceEditorOpen = false" />
                    <UButton type="submit" color="primary" :loading="isSavingDevice" label="Zapisz adres" aria-label="Zapisz adres urządzenia" />
                  </div>
                </div>
              </form>
        ...
        <div class="flex justify-end gap-3">
          <UButton color="gray" variant="ghost" to="/customers" label="Anuluj" aria-label="Anuluj edycję klienta" />
          <UButton type="submit" color="primary" :loading="isSaving" label="Zapisz zmiany" aria-label="Zapisz dane klienta" />
        </div>
      </section>
...
const saveDeviceAddress = async () => {
  ...
  try {
    ...
    toast.add({
      ...
      description: 'Pomyślnie zapisano adres urządzenia.',
      color: 'success'
    })
    await refresh()
  } catch (error) {
...
const saveCustomer = async () => {
  ...
  try {
    ...
    toast.add({
      title: 'Dane zapisane',
      description: 'Pomyślnie zaktualizowano dane klienta.',
      color: 'success'
    })
    await refresh()
  } catch (error) {
