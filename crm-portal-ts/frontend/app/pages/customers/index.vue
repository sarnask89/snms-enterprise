    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
      ...
      <div class="flex flex-wrap gap-2">
        <UDropdown :items="extraActions" :popper="{ placement: 'bottom-end' }">
          <UButton icon="i-heroicons-ellipsis-horizontal" color="gray" variant="ghost" label="Więcej" />
        </UDropdown>
        <UButton
      ...
      <UCard v-if="isCreatePanelOpen">
        <template #header>
          <div class="flex items-center justify-between gap-3">
            <div>
              <h2 class="text-base font-semibold text-gray-900 dark:text-white">Nowy abonent</h2>
              <p class="text-sm text-gray-500 dark:text-gray-400">Szybki formularz operatorski bez schodzenia do osobnego widoku.</p>
            </div>
            <UButton
              color="gray"
              variant="ghost"
          ...
          <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">
                Widok tabelaryczny rozciągnięty na całą szerokość roboczą, bez bocznych paneli.
              </p>
            </div>
...
const extraActions = computed(() => [[
  { label: 'Grupy klientów', icon: 'i-heroicons-user-group', to: '/customers/groups' },
  {
