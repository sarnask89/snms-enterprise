      ...
      <UCard v-if="isCreatePanelOpen">
        <template #header>
          <div class="flex items-center justify-between gap-3">
            ...
            <UButton color="neutral" variant="ghost" icon="i-lucide-x" aria-label="Zamknij formularz nowego abonenta" @click="isCreatePanelOpen = false" />
          </div>
        </template>
          ...
          <div class="text-right">
            ...
            >
              <UButton
                ...
                variant="ghost"
                class="ml-auto"
                :aria-label="`Więcej opcji dla klienta: ${row.displayName}`"
              />
            </UDropdownMenu>
          </div>
        </template>
