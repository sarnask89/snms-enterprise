        ...
        <form @submit.prevent="createCustomer" class="space-y-4">
          <div class="grid gap-3 xl:grid-cols-4">
            <UFormField label="Kod klienta" required>
              <UInput v-model="newCustomer.customerCode" placeholder="np. K/001/2024" />
            </UFormField>
            ...
            <UFormField label="Telefon">
              <UInput v-model="newCustomer.phone" placeholder="np. +48 600 700 800" />
            </UFormField>
          </div>
          ...
          <div v-else class="grid gap-3 xl:grid-cols-2">
            <UFormField label="Nazwa firmy" required>
              <UInput v-model="newCustomer.companyName" placeholder="np. Acme Sp. z o.o." />
            </UFormField>
            <UFormField label="NIP">
              <UInput v-model="newCustomer.nip" placeholder="np. 5261040828" />
            </UFormField>
          </div>
