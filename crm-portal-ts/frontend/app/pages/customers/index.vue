        ...
        <form @submit.prevent="createCustomer" class="space-y-4">
          <div class="grid gap-3 xl:grid-cols-4">
            <UFormField label="Kod klienta" required>
              <UInput v-model="newCustomer.customerCode" placeholder="np. 12345" />
            </UFormField>
            ...
            <UFormField label="Telefon">
              <UInput v-model="newCustomer.phone" placeholder="np. +48 123 456 789" />
            </UFormField>
          </div>

          <div v-if="newCustomer.customerType === 'individual'" class="grid gap-3 xl:grid-cols-2">
            <UFormField label="Imię" required>
              <UInput v-model="newCustomer.firstName" placeholder="np. Jan" />
            </UFormField>
            <UFormField label="Nazwisko" required>
              <UInput v-model="newCustomer.lastName" placeholder="np. Kowalski" />
            </UFormField>
          </div>

          <div v-else class="grid gap-3 xl:grid-cols-2">
            <UFormField label="Nazwa firmy" required>
              <UInput v-model="newCustomer.companyName" placeholder="np. Firma Usługowa S.A." />
            </UFormField>
            <UFormField label="NIP">
              <UInput v-model="newCustomer.nip" placeholder="np. 1234567890" />
            </UFormField>
          </div>
