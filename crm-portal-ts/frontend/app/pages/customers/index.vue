    ...
    <template #body>
      ...
      <div class="flex flex-wrap items-center justify-between gap-2">
        <UInput
          ...
          aria-label="Wyszukiwanie abonentów"
        />

        <div class="flex flex-wrap items-center gap-2">
          <USelect v-model="statusFilter" :items="statusItems" class="min-w-32" aria-label="Filtruj według statusu" />
          <USelect v-model="customerTypeFilter" :items="customerTypeItems" class="min-w-36" aria-label="Filtruj według typu klienta" />
          <USelect v-model="autoGeneratedFilter" :items="sourceItems" class="min-w-40" aria-label="Filtruj według źródła" />
          <UButton
          ...
          <div class="text-right">
            ...
            >
              <UButton
                ...
                variant="ghost"
                class="ml-auto"
                :aria-label="`Opcje dla klienta ${row.displayName}`"
              />
            </UDropdownMenu>
          </div>
        </template>
