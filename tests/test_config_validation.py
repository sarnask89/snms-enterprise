...
def test_validate_security_log():
    log = MagicMock()
    _validate_security(log)
    log.info.assert_called_with("Security: Critical environment variables (SECRET_KEY, ENCRYPTION_KEY, ADMIN_PASSWORD) validated by config loader.")
